...
class AssignClaimRequestForm extends sfForm
{
    private $currencies;
    ...
    public function configure()    {
        ...
        $this->setWidgets(array(
            ...
            'empName' => new sfWidgetFormSelect(array('choices'=>$this->employees)),
        ...
        $this->setValidators(array(
            ...
            'empName'=> new sfValidatorChoice(array('required'=>true,'choices'=> array_keys($this->employees))),
            'eventType'=> new sfValidatorChoice(array('required' => true,'choices' => array_keys($this->eventTypes))),
            'description'=> new sfValidatorString(array('required'=>true, 'max_length'=> 1000)),
