...
use_javascript(plugin_web_path('orangehrmClaimPlugin', 'js/viewClaimSuccess'));

?>

<div class="box" id="adminSubmitClaim">
    <div class="head">
    ...
    <div class="inner" id="innerDiv">
        ...
        <form name="frmSubmitClaim" id="frmSubmitClaim" method="post"
              action="<?php echo url_for('claim/adminSubmitClaim'); ?>">
            ...
            <fieldset>
                ...
                <p>
                    <input type="submit" class="editable" name="btnCreate" id="btnCreate" value="<?php echo __('Submit') ?>"/>
