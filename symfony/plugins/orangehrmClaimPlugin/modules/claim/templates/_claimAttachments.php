...
<div id="addPaneAttachments">
    ...
    <div class="inner">
        ...
        <form name="frmClaimAttachment" id="frmClaimAttachment" method="post" enctype="multipart/form-data" action="<?php echo url_for('claim/uploadClaimAttachments?claimRequestId='.$claimRequestId); ?>">


            <?php echo $form['_csrf_token']; ?>
            <input type="hidden" name="requestId" value="<?php echo $claimRequestId;?>"/>
...
<div id="attachmentList" class="miniList">
    ...
    <div class="inner">
        ...
        <form name="frmEmpDelAttachments" id="frmEmpDelAttachments" method="post" action="<?php echo url_for('claim/deleteClaimAttachments?claimRequestId='.$claimRequestId); ?>">
                        ...
                        <?php $cssClass = ($row%2) ? 'even' : 'odd'; ?>
                            ...
                            <tr class="<?php echo $cssClass;?>">
                                ...
                                <td>
                                    ...
                                    href="<?php echo url_for('claim/uploadClaimAttachments?claimRequestId='.$claimRequestId. '&attachId=' . $attachment->attach_id);?>">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $("#frmClaimAttachment").data('add_mode', true);

        jQuery.validator.addMethod("attachment",
        function() {

            var addMode = $("#frmClaimAttachment").data('add_mode');
            if (!addMode) {
                return true;
            } else {
                var file = $('#ufile').val();
    ...
    var attachmentValidator =
        ...
        $('#attachmentList a.editLink').click(function(event) {
            ...
            $("#frmClaimAttachment").data('add_mode', false);
        ...
        $("#attachmentsCheckAll").click(function() {
            if($(":checkbox").length == 1) {
                ...
                if($("#attachmentsCheckAll").is(':checked')) {
                    $('#btnDeleteAttachment').removeAttr('disabled');
                } else {
                    $('#btnDeleteAttachment').attr('disabled','disabled');
                }
        ...
        $('#frmEmpDelAttachments').attr('name', 'frmEmpDelAttachments');
        $('#dialogDeleteBtn').click(function () {
            document.frmEmpDelAttachments.submit();
        });
